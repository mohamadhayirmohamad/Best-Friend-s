...
function Contact() {
    return (
        <>
            ...
            <div>
                {/* Contact Form */}
                <div className="contact-us" style={{ backgroundColor: "#FFC73C", padding: "50px" }}>
                ...
                {/* How to reach us */}
                <div className="how-to-reach-us text-center py-5" style={{ backgroundColor: "#FFF" }}>
                    <h2>How to reach us</h2>
                    <div className="d-flex justify-content-center flex-wrap mt-4">
                        <div className="m-3 text-center">
                            <div style={{ color: "white"  , fontSize:"2rem"}} className="icon-container">
                                <i className="fas fa-home"></i>
                            </div>
                            <h5>Address</h5>
                            <p>Street Name, Zip Code, Country</p>
                            <p>mail@mailservice.com</p>
                            <p>(555) 555-5555</p>
                        </div>
                        <div className="m-3 text-center">
                            <div style={{ color: "white" , fontSize:"2rem" }} className="icon-container">
